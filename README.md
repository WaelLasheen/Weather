...
<div style="display: flex; flex-direction: row; gap: 20px; flex-wrap: wrap; max-width: 1000px; margin: 0 auto;">
  <div style="text-align: center;">
    ...
    <p style="margin-top: 10px;">Ask Permission for Location</p>
  </div>
  <div style="text-align: center;">
    ...
    <p style="margin-top: 10px;">Current Location Weather UI</p>
  </div>
  <div style="text-align: center;">
    ...
    <p style="margin-top: 10px;">Detailed Weather Information</p>
  </div>
  <div style="text-align: center;">
    ...
    <p style="margin-top: 10px;">Search for City Weather</p>
  </div>
</div>
