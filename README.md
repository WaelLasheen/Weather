...
<div style="max-width: 1000px; margin: 0 auto;">
  <img src="https://github.com/user-attachments/assets/07bf52d5-bb03-441a-857e-fb343d58a8a9" alt="Ask Permission for Location" width="200" style="display: inline-block; vertical-align: top; margin-right: 20px;"/>
  <p style="text-align: center; margin: 10px 0 0 0;">Ask Permission for Location</p>
  <img src="https://github.com/user-attachments/assets/d9cc3783-a47a-4f68-a48a-197f75a0eeca" alt="Current Location Weather UI" width="200" style="display: inline-block; vertical-align: top; margin-right: 20px;"/>
  <p style="text-align: center; margin: 10px 0 0 0;">Current Location Weather UI</p>
  <img src="https://github.com/user-attachments/assets/573c1854-3505-48e4-ad5d-59ef4e7682be" alt="Detailed Weather Information" width="200" style="display: inline-block; vertical-align: top; margin-right: 20px;"/>
  <p style="text-align: center; margin: 10px 0 0 0;">Detailed Weather Information</p>
  <img src="https://github.com/user-attachments/assets/d9432a40-c1eb-4c71-9133-4ecc970a2860" alt="Search for City Weather" width="200" style="display: inline-block; vertical-align: top;"/>
  <p style="text-align: center; margin: 10px 0 0 0;">Search for City Weather</p>
</div>
